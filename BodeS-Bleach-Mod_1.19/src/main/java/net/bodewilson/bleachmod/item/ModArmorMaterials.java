...
{   /*
    ...
    REIATSU("reiatsu", -1, new int[]{3, 6, 8, 3}, 15,
            SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 3.0F, 0.1F, () -> {
    return Ingredient.ofItems(new ItemConvertible[]{ModItems.REIATSU_INGOT});
});
